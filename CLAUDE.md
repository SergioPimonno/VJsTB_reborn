...
2. **У каждого добавленного/заметно изменённого функционала есть документация
   ...
   - **Известный факт на 2026-08-15**: все 10 интерактивных сценариев в базе
     ПУСТЫЕ (ноль шагов у каждого) — это не баг текущей сессии, это ранее
     не выполненная работа. Полноценные пошаговые сценарии со скриншотами —
     трудоёмкая отдельная задача (реальные скриншоты приложения на каждый шаг
     + хотспоты), не делать её попутно с чем-то другим без явного запроса.
